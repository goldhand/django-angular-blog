...
class Common(Configuration):
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/django-angular-blog')
...
class Local(Common):
    ...
    DEFAULT_FROM_EMAIL = values.Value(
        'django-angular-blog <will@django.nu>')
    EMAIL_HOST = values.Value('smtp.sendgrid.com')
    EMAIL_HOST_PASSWORD = values.SecretValue(environ_prefix="", environ_name="SENDGRID_PASSWORD")
    EMAIL_HOST_USER = values.SecretValue(environ_prefix="", environ_name="SENDGRID_USERNAME")
    EMAIL_PORT = values.IntegerValue(587, environ_prefix="", environ_name="EMAIL_PORT")
    EMAIL_SUBJECT_PREFIX = values.Value('[django-angular-blog] ', environ_name="EMAIL_SUBJECT_PREFIX")
    EMAIL_USE_TLS = True
    ########## End mail settings
	...
	'default': {
	    ...
	    'NAME': 'django-angular-blog',                      # Or path to database file if using sqlite3.
...
class Production(Common):
    ...
    ########## EMAIL
    DEFAULT_FROM_EMAIL = values.Value(
            'django-angular-blog <django-angular-blog-noreply@django.nu>')
    EMAIL_HOST = values.Value('smtp.sendgrid.com')
    EMAIL_HOST_PASSWORD = values.SecretValue(environ_prefix="", environ_name="SENDGRID_PASSWORD")
    EMAIL_HOST_USER = values.SecretValue(environ_prefix="", environ_name="SENDGRID_USERNAME")
    EMAIL_PORT = values.IntegerValue(587, environ_prefix="", environ_name="EMAIL_PORT")
